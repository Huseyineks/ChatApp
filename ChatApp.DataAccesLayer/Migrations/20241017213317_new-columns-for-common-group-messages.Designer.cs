...
namespace ChatApp.DataAccesLayer.Migrations
{
    ...
    [Migration("20241017213317_new-columns-for-common-group-messages")]
    partial class newcolumnsforcommongroupmessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp.EntitiesLayer.Model.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp.EntitiesLayer.Model.Message", b =>
                {
                    ...
                    b.Property<string>("replyingToMessage")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ChatApp.EntitiesLayer.Model.AppUserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ChatApp.EntitiesLayer.Model.AppUser", null)
                        .WithMany()
